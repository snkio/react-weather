    ...
    <>
      {city && (
        <section className="grid grid-cols-2 gap-4">
          <div className="w-full bg-bg-block rounded-2xl p-4">
            <div className="flex items-center">
              <img src={sunIcon} alt="" aria-hidden="true" />
              <p className="text-sm uppercase tracking-wide">Sunrise</p>
            </div>
            <h3 className="text-4xl font-bold">
              {weather?.daily?.sunrise.hour}
            </h3>
            <p>Sunset: {weather?.daily?.sunset.hour}</p>
          </div>
          <div className="w-full bg-bg-block rounded-2xl p-4">
            <div className="flex items-center">
            ...
            <h3 className="text-4xl font-bold">{weather?.now?.humadity}%</h3>
          </div>
          <div className="w-full bg-bg-block rounded-2xl p-4">
            <div className="flex items-center">
